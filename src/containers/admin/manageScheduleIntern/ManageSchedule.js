...
import { ROUTE_MANAGESCHEDULE_DETAIL } from '../../../utils/routes';
            ...
            <Table stickyHeader aria-label="sticky table">
              ...
              <TableBody>
                {rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                  return (
                    <TableRow hover role="checkbox" tabIndex={-1} key={row.code} onClick={() => { history.push(ROUTE_MANAGESCHEDULE_DETAIL) }}>
                      {columns.map((column) => {
