...
export const taskListData = [
    {
        id: 1, nameProject: "Abc", listNameTask: [
            { task: "Cv1", taskDetails: [{ id: "content_c11", value: "Content 1 Content 1 Content 1 Content 1 Content 1 Content 1 Content 1 Content 1" }], checked: true },
            { task: "Cv2", taskDetails: [{ id: "content_c21", value: "Content 1" }], checked: false }],
